...
for distance_from_atms in range(1, 11):
	otm_ce_name, otm_pe_name, ce_OTM_strike, pe_OTM_strike = tsl.OTM_Strike_Selection('FINNIFTY','10-09-2024',distance_from_atms)
